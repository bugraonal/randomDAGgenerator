...
def distrubute(numNodes, numLevels, saturationFraction):
    """
...
def firstPass(numNodes, numLevels, dist):
    """
...
dist = distrubute(numNodes, numLevels, saturationFraction)

levels = firstPass(numNodes, numLevels, dist)
secondPass(levels)
